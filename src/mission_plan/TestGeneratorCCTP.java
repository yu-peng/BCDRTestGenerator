...
public class TestGeneratorCCTP {
    ...
    double centerLat = 0;
    double centerLon = 0;
    double missionRadius = 100; // kilometers
	...
	public void addMission(Event leaveStart, Event arriveEnd, Location start, Location end, CCTP newCTPP){
		...
		double[] mission = getMissionDuration();
	...
	public static double[] getMissionDuration(){
		
		double lb = 0;
		double ub = getRandomDouble(lb,missionLimit); // convert minutes to milliseconds
